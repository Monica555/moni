        <footer class="main-footer">
            ...
            Sistema desarrollado por <strong>@moni</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
<!-- jQuery 3 -->
...
$(document).ready(function () {
    ...
    $(document).on("keyup", "#tbventas input.cantidades", function(){
        ...
        $(this).closest("tr").find("td:eq(5)").children("p").text(importe.toFixed(0))
        $(this).closest("tr").find("td:eq(5)").children("input").val(importe.toFixed(0))
        sumar()  
        //validamos los campos del cuadro ventas
        validar_venta()
    })
...
function sumar(){
    ...
    igv = subtotal / 11
    $("input[name=igv]").val(igv.toFixed(0)) 
